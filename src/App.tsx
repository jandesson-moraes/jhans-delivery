                ...
                {pasteArea ? (
                   <div className="space-y-4 animate-in slide-in-from-right">
                    ...
                    <form onSubmit={submit} className="space-y-5">
                       ...
                       <div className="space-y-4">
                           <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Cliente</label><input required className="w-full border-2 border-slate-300 rounded-xl p-3.5 focus:border-orange-500 focus:ring-4 focus:ring-orange-50 outline-none transition-all font-normal text-slate-300 placeholder:text-slate-400" placeholder="Nome do Cliente" value={form.customer} onChange={e=>setForm({...form, customer: e.target.value})} /></div>
                           <div className="grid grid-cols-2 gap-4">
                              <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Telefone</label><input required className="w-full border-2 border-slate-300 rounded-xl p-3.5 outline-none focus:border-orange-500 transition-all font-normal text-slate-300 placeholder:text-slate-400" placeholder="(00) 00000-0000" value={form.phone} onChange={e=>setForm({...form, phone: e.target.value})} /></div>
                              <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Valor</label><input required className="w-full border-2 border-slate-300 rounded-xl p-3.5 outline-none focus:border-orange-500 transition-all font-normal text-slate-300 placeholder:text-slate-400" placeholder="R$ 0,00" value={form.amount} onChange={e=>setForm({...form, amount: e.target.value})} /></div>
                           </div>
                           <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Pagamento</label><input className="w-full border-2 border-slate-300 rounded-xl p-3.5 outline-none focus:border-orange-500 transition-all font-normal text-slate-300 placeholder:text-slate-400" placeholder="PIX, Dinheiro..." value={form.paymentMethod} onChange={e=>setForm({...form, paymentMethod: e.target.value})} /></div>
                           <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Endereço</label><input required className="w-full border-2 border-slate-300 rounded-xl p-3.5 outline-none focus:border-orange-500 transition-all font-normal text-slate-300 placeholder:text-slate-400" placeholder="Rua, Número, Bairro" value={form.address} onChange={e=>setForm({...form, address: e.target.value})} /></div>
                           ...
                           <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Itens</label><textarea required className="w-full border-2 border-slate-300 rounded-xl p-3.5 outline-none focus:border-orange-500 transition-all font-normal text-slate-300 placeholder:text-slate-400 min-h-[80px]" placeholder="Descrição do pedido..." value={form.items} onChange={e=>setForm({...form, items: e.target.value})} /></div>
                           <div><label className="text-xs font-bold text-slate-600 uppercase mb-1 block">Obs</label><input className="w-full border-2 border-slate-300 rounded-xl p-3.5 outline-none focus:border-orange-500 transition-all font-normal text-slate-300 placeholder:text-slate-400" placeholder="Ex: Troco para 50" value={form.obs} onChange={e=>setForm({...form, obs: e.target.value})} /></div>
                       </div>
